...
var Brand = ({ src, alt, width, height }) => /* @__PURE__ */ jsx(
...
var SectionWrapper = ({ children, className }) => /* @__PURE__ */ jsx3(
  "section",
  {
...
var CenteredCTAText = ({ title, description }) => {
  return /* @__PURE__ */ jsx4(SectionWrapper, { children: /* @__PURE__ */ jsx4("div", { className: "custom-screen text-center", children: /* @__PURE__ */ jsxs("div", { className: "max-w-xl mx-auto", children: [
    /* @__PURE__ */ jsx4("h2", { className: "text-gray-800 text-3xl font-semibold sm:text-4xl", children: title }),
